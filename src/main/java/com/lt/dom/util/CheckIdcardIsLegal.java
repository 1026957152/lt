...
// 判断出生年月是否有效   
        ...
        if(isVarifyCode(Id,Idcard)==false){  
        mesgStr = "身份证校验码无效，不是合法的身份证号码!";  
            return mesgStr;  
        }  
return "yes";
}
...
* 校验码：  1  0  X  9  8  7  6  5  4  3   2 
    */  
   private static boolean isVarifyCode(String Id,String IDStr) {  
...
/** 
    ...
    String string = CheckIdcardIsLegal.checkIdCard("612724198409210339");
...
/*
————————————————
版权声明：本文为CSDN博主「是山山而川啊」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_43816935/article/details/112261384*/
