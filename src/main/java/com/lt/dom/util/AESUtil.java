...
public class AESUtil {
    ...
    public static void main(String[] a)
        ...
        CompaignPojo.Student student = new CompaignPojo.Student();
    ...
    public static String de(String cipherText)
        ...
        CompaignPojo.Student student = (CompaignPojo.Student) JSON.parse(decryptedCipherText);;
        Timestamp timestamp = new Timestamp(student.getAge());


        if(timestamp.toLocalDateTime().plusSeconds(50).isBefore(LocalDateTime.now()))
            return null;
    ...
    public static String en(String a)
            throws InvalidKeySpecException, NoSuchAlgorithmException,
            IllegalBlockSizeException, InvalidKeyException, BadPaddingException,
            InvalidAlgorithmParameterException, NoSuchPaddingException {
        ...
        CompaignPojo.Student student = new CompaignPojo.Student();
        student.setAge(Timestamp.valueOf(LocalDateTime.now()).getTime());
        student.setName(a);

        String plainText =JSON.toJSONString(student);
        String password = "baeldung";
        String salt = "12345678";
        IvParameterSpec ivParameterSpec = AESUtil.generateIv();
        SecretKey key = AESUtil.getKeyFromPassword(password,salt);
