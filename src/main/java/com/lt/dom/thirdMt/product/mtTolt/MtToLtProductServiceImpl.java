...
import com.lt.dom.thirdPft.domainPftTolt.PftToLvApiOrderDetail;
import com.lt.dom.thirdPft.domainPftTolt.PftToLvOrderCreate;
import com.lt.dom.thirdPft.domainPftTolt.PftToLvRet;
import com.lt.dom.thirdPft.domainPftTolt.PftToLvRetApiOrderDetail;
...
@Service
public class MtToLtProductServiceImpl {
...
/*————————————————
    ...
    //请求系统存活检查推送
    public mtpDealResponse Server_meituan_trip_order_create(mtpDealRequest pft) {
