...
public class SightSpecification implements Specification<Attraction> {

    private SightsQueryfieldsCriteria criteria;
    private EnumPrivacyLevel privacyLevel;

    public SightSpecification(SightsQueryfieldsCriteria searchCriteria) {
    ...
    public Predicate toPredicate
      ...
      (Root<Attraction> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
