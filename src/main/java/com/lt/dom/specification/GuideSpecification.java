...
public class GuideSpecification implements Specification<Guide> {

    private List<String> columns;

    private String keyword;
    public GuideSpecification(List<String> columns, String keyword) {
    ...
    public Predicate toPredicate
      ...
      (Root<Guide> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
