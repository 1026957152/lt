...
public class ProductQueryfieldsCriteria {
...
private String code;//
    ...
    private List<EnumProductStatus> statuses;

    public List<EnumProductStatus> getStatuses() {
        return statuses;
    }

    public void setStatuses(List<EnumProductStatus> statuses) {
