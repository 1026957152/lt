...
public class PolylinePointProto extends BaseResp {
    private Double lat;
    private Double lng;
    private List places;
    private LocalTime departure_time;

    public static PolylinePointProto of(PolylinePoint e) {
        PolylinePointProto busStopResp = new PolylinePointProto();
    ...
    public static class Live {
        ...
        public static PolylinePointProto.Live of(BusAndStopUpdateMessage.StopUpdateMessage message) {
            PolylinePointProto.Live live1 = new PolylinePointProto.Live();
    ...
    private PolylinePointProto.Live live;
