...
@Service
public class PftToLtServiceImpl {
...
/*————————————————
    ...
    //请求系统存活检查推送
    public PftToLvRet Server_CheckAlive(PftToLvCheckAlive pft) {

        return ok();
    }
    //请求下单通知推送
    public PftToLvRet Order_Create(PftToLvOrderCreate pft) {

        return ok();
    }

    //请求支付通知推送
    public PftToLvRet Order_Pay(PftToLvOrderPay pft) {
    ...
    //请求取消通知推送
    public PftToLvRet Order_Cancel(LtToPftRetPftCancel cancel) {
    ...
    //请求重发短信通知推送
    public  PftToLvRet  Order_ResendMsg(PftToLvOrderResendMsg pft) {
