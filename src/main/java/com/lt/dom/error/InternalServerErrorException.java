...
public class InternalServerErrorException extends RuntimeException {
    ...
    public InternalServerErrorException(Enumfailures error, String message, String detail) {
        this.error = error;
    ...
    public InternalServerErrorException(long id, String message) {
        this.id = id;
        this.message = message;
    }
    ...
    public InternalServerErrorException(Enumfailures error, String message) {
