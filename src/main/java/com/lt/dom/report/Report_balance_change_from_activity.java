...
public class Report_balance_change_from_activity {
  ...
  //  agent_id
    ...
    public static Report_balance_change_from_activity from(RedemptionEntry x) {
        Report_balance_change_from_activity excelVoucher = new Report_balance_change_from_activity();
    ...
    public static Report_balance_change_from_activity from(RedemptionEntry x, Traveler traveler, Supplier supplier) {
        Report_balance_change_from_activity excelVoucher = new Report_balance_change_from_activity();
