...
*/
    ...
    public void refundCompleted(Refund refund ,Charge charge, Reservation reservation) {
        if(!charge.getChannel().equals(EnumPayChannel.cash)){
            return;
        }
    ...
    public void refundPending(Refund refund ,Charge charge, Reservation reservation) {
        ...
        refund.setRefundType(EnumRefundType.External);

        refund.setSourceType(EnumRefundSourceType.CreditBalance);
    ...
    public void createRefundNonReferenced(EnumPayChannel payChannel, Refund refund , Reservation reservation) {
        if(!payChannel.equals(EnumPayChannel.cash)){
