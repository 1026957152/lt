...
import com.lt.dom.OctResp.MetricsDTO;
...
@Service
public class ReviewCountServiceImpl {
...
/*        if(referral.getType().equals(EnumReferralType.fill_up_passager_info)){
    ...
    public void fill(Product product, ProductResp productResp) {

        productResp.setReviewCount(10l);


    }

    public void metrics(ProductResp productResp, Product e) {
        MetricsDTO metricsDTO = new MetricsDTO();
        metricsDTO.setViews(10);
        productResp.setMetrics(metricsDTO);
    }
}
