...
public class TheatreServiceImpl {
    ...
    //    fileStorageService.saveFromTempDocumentWithRich(theatre.getCode(), theatreReq.getCover(),EnumDocumentType.theatreImageStandard);
    ...
    public Theatre update(Theatre theatre, TheatreReq theatreReq) {
        theatre.setName(theatreReq.getName());
        theatre.setLongName(theatreReq.getLongName());
        theatre.setShortdesc(theatreReq.getShortdesc());
        theatre.setLongdesc(theatreReq.getLongdesc());
        ...
        if(theatreReq.getCover() != null){
            fileStorageService.updateFromTempDocument(theatre.getCode(), theatreReq.getCover(),EnumDocumentType.theatreImageStandard);
