...
public enum EnumVerificationDocumentType_type {
    driving_license("Retail travel agent"),
    passport("Trusted travel agent"),

    id_card("Trusted travel agent"),
...
//1 = Lead customer (Customer will pay - but net of any commission due on the booking) If the booking is value of 100 and the travel agent is on 10% commission the customer will pay 90
    ...
    EnumVerificationDocumentType_type(String name) {
        this.name = name;
    }
