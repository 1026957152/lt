...
public enum EnumLineType {
    ...
    AudioTourGuide("Printed"),//http://talesandtours.com/guide/673/ely-city.html
    Multi_Ticket("Printed"),//http://talesandtours.com/guide/673/ely-city.html
