...
public class MarketAgentResp {
    ...
    public static class Connection {
        ...
        public <T> void setChannels(List channels) {
    ...
    public static MarketAgentResp from(RequestResp request) {
        MarketAgentResp supplierResp = new MarketAgentResp();
    ...
    public static MarketAgentResp from(Supplier supplier, List<Asset> assets) {
    ...
    public static MarketAgentResp from(Supplier supplier) {
        MarketAgentResp supplierResp = new MarketAgentResp();
    ...
    public static MarketAgentResp simpleFrom(Supplier supplier) {
        MarketAgentResp supplierResp = new MarketAgentResp();
        supplierResp.setCode(supplier.getCode());
        supplierResp.setName(supplier.getName());
        supplierResp.setDesc(supplier.getDesc());
    ...
    public static MarketAgentResp verySimpleFrom(Supplier supplier) {
        MarketAgentResp supplierResp = new MarketAgentResp();
        supplierResp.setCode(supplier.getCode());
        supplierResp.setName(supplier.getName());
        return supplierResp;
