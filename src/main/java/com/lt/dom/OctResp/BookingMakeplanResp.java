...
import com.lt.dom.oct.BookingMakeplan;
import com.lt.dom.otcReq.BookingMakeplanReq;
...
public class BookingMakeplanResp {
    ...
    public static BookingMakeplanResp from(BookingMakeplan e) {
        BookingMakeplanResp bookingMakeplanReq = new BookingMakeplanResp();
        bookingMakeplanReq.setBookedFrom(e.getBookedFrom());
        bookingMakeplanReq.setBookedTo(e.getBookedTo());
        bookingMakeplanReq.setAll_day(e.isAll_day());
        bookingMakeplanReq.setNotes(e.getNotes());
        bookingMakeplanReq.setState(e.getState());
        bookingMakeplanReq.setStatus(e.getStatus());

        return bookingMakeplanReq;
    }
