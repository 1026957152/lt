...
public class MediaEditResp {
    ...
    public static MediaEditResp from(Media media) {
        MediaEditResp mediaResp = new MediaEditResp();
    ...
    public static MediaEditResp simpleFrom(Media media) {
        MediaEditResp mediaResp = new MediaEditResp();
        mediaResp.setHref(media.getHref());
        mediaResp.setPreview_image_url(media.getPreview_image_url());
        mediaResp.setMediaType(media.getMediaType());
