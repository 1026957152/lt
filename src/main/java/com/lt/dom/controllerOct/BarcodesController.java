...
import com.lt.dom.util.BarbecueBarcodeGenerator;
import com.lt.dom.util.Barcode4jBarcodeGenerator;
...
public class BarcodesController {
    ...
    @GetMapping(value = "/zxing/qrcode_/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    public ResponseEntity<BufferedImage> getZxingQRCode(@PathVariable String barcode) throws Exception {
        return okResponse(ZxingBarcodeGenerator.generateQRCodeImage(barcode));
    }
    //QRGen
