...
public class OnQrcodeReaderScanSuccessEvent extends ApplicationEvent {
    private EnumEvents event;
    private QrcodeReaderResult charge;
    private User user;

    public OnQrcodeReaderScanSuccessEvent(
            User user, QrcodeReaderResult charge, EnumEvents appUrl) {
        super(user);
